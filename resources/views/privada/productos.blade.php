...
$("#cant"+modelo).html("<input type='number' min='1' id='1' name='cantidades' value='99' style='width: 46px;' disable>");
  ...
  <div id="modal{!! $producto->id !!}" class="modal">
            ...
            <div class="col l12 m12 s12" style="padding-left: 0px;">   
                ...
                <div class="modal_contenido">
                    ...
                    @foreach($producto->modelos as $modelo)
                            ...
                            <td class="tablamodelos">
                                @if($producto->precio_sin_oferta==null)
                                {!! '$'.$producto->precio !!}
                               @else
                               ...
                               <br>
                                <span style="color: #AA0000;">
                                    <strike> {!! '$'.$producto->precio_sin_oferta !!}</strike>
                                </span>
                               @endif
                            </td>
                            <td class="tablamodelos">
    ...
    <div id="carrito{{$modelo->id}}"  class="right">
        <img src="{{ asset('img/check.png') }}" style="font-size: 30px;height: 30px;"/>
    </div>
  ...
  $('.enviar').click(function(){
    ...
    if(cantidad>0)
    {
        $.ajax({
            ...
            $("#carrito"+modelo).html("<img src='./../img/check.png' style='font-size: 30px;height: 30px;'>");
