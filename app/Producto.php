...
class Producto extends Model
{
    ...
    protected $fillable = [
        'nombre', 'ventajas', 'descripcion', 'contenido', 'categoria_id', 'caracteristicas', 'manual', 'despiece', 'visible', 'orden', 'presentacion', 'imagen_presentacion', 'precio', 'rubro_id', 'modelo_id', 'tipo', 'iva', 'aplica_desc', 'precio_sin_oferta',
    ];
    ...
    {
        return $this->belongsToMany('App\Pedido', 'pedido_producto')->withPivot('cantidad', 'costo', 'iva', 'total', 'codigo', 'medida');
    }
